...
- `packages/phosphoresce` — the summarization pipeline as a standalone npm package ([README](packages/phosphoresce/README.md)). Framework-free; other apps can depend on it.
